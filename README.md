...
In order to run this project you need: **[ruby installed](https://www.ruby-lang.org/en/)**
...
```
  RUN mkdir my-folder
  RUN cd my-folder
  RUN git clone https://github.com/fezzopro/ruby-enumerable.git
...
### Usage
 ...
 - Install Ruby to your environment
 - RUN `ruby main.rb`
